...
fb = pd.read_csv('C:/Users/JacobBrooks/Downloads/fb_stock_prices_2018.csv', index_col='date', parse_dates=True)
quakes = pd.read_csv('C:/Users/JacobBrooks/Downloads/earthquakes.csv')
covid = pd.read_csv('C:/Users/JacobBrooks/Downloads/covid19_cases.csv').assign(
